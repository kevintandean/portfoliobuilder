...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Color.color'
        db.alter_column(u'builder_color', 'color', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Color.color'
        db.alter_column(u'builder_color', 'color', self.gf('django.db.models.fields.CharField')(default=1, max_length=30))
    ...
    models = {
        ...
        u'builder.color': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'builder.project': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "'Description here, lorem ipsum.....'", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "'title here'", 'max_length': '100', 'null': 'True'}),
